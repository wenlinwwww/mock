...
//        Product product2 = new Product(20.0, "DIS_10_PRODUCT2", "product 2");
        Product product1 = new Product(20.0, "", "product", "null");
        Product product2 = new Product(20.0, "", "product", "BUY_FIVE_GET_TWO_FREE");
...
//        Product product3 = new Product(30.0, "DIS_10_PRODUCT3", "product 3");
        Product product3 = new Product(20.0, "", "product", "BUY_FIVE_GET_TWO_FREE");
